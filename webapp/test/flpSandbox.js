					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Accmaker DBLOTS",
									"targetURL": "#accmaker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"accmaker-display": {
								"semanticObject": "accmaker",
								"action": "display",
								"description": "Accmaker DBLOTS",
								"title": "Accmaker DBLOTS",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=accmaker",
									"url": sap.ui.require.toUrl("accmaker")
								}
							}
						}
					}
